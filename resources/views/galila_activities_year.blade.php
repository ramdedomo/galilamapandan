...
<html lang="en">
    <head>
        ...
        <title>Galila Mapandan | Activities and Programs</title>
        <!-- Favicon-->
    ...
    <body class="d-flex flex-column h-100 bg-dark bg-opacity-5">
                    ...
                    <div class="collapse navbar-collapse float-end" id="navbarSupportedContent">
                        <div class="mb-3 mt-5"></div>
                            <ul class="nav nav-pills text-dark ms-auto mb-lg-0 nav-fill">
                                ...
                                <li class="nav-item p-2">
                                  <a class="nav-link shadow-sm text-light bg-opacity-10" style="background-color: #03C85D;" href="/activitiesandprograms">ACTIVITIES AND PROGRAMS</a>
                                </li>
                                <li class="nav-item p-2">
     ...
     <header class="">
        ...
        <div class="container px-5">
            <div class="col-lg-11 col-xl-11 col-xxl-11  p-0">
                <div class="my-5 text-xl-start">
                    <div class="mb-3">
                        <a class="text-decoration-none" href="/activitiesandprograms"><div class="badge bg-galila rounded-pill mb-2">Galila Mapandan Activities and Programs</div></a> - <div class="badge text-dark rounded-pill mb-2">{{ $desc[0]->year }}</div>
                    </div>
                    
                    <h1 class="display-5 fw-bolder text-dark mb-2 montserrat">{{ $desc[0]->year }}</h1>
                </div>
            </div>
    </div>
