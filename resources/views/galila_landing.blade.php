                ...
                <div class="container px-5">
                    ...
                    <hr class="mt-3 d-none d-sm-block">
                        ...
                        @if (($itm->carousel_item_design) == 1)
                                ...
                                height: 580px;
                                background: linear-gradient(hsla(0, 0%, 100%, 0.8), hsla(0, 0%, 100%, 0.8)), url(data:image/png;base64,{{ base64_decode(hex2bin(substr($itm->carousel_item_bg, 2))) }}) no-repeat;
                        ...
                        @endphp
                                ...
                                style="
                                height: 580px;
                                background-image: url(data:image/png;base64,{{ base64_decode(hex2bin(substr($itm->carousel_item_bg, 2))) }});
                                background-position: center;
                                background-size: cover;
                                background-repeat: no-repeat;
                                ">
