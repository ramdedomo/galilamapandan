        ...
        <main class="flex-shrink-0">
                    ...
                    <hr class="mt-3 d-none d-sm-block">
                        ...
                        <div id="carouselExampleControls" class="carousel slide d-none d-sm-block"  data-bs-ride="carousel">
                            ...
                            @if (($itm->carousel_item_design) == 1)
                                ...
                                height: 580px;
                                background: linear-gradient(hsla(0, 0%, 100%, 0.8), hsla(0, 0%, 100%, 0.8)), url(data:image/png;base64,{{ strval($itm->carousel_item_bg) }}) no-repeat;
                                    ...
                                    <div class="col-lg-8 col-xl-7 col-xxl-6">
                                        <div class="my-5 text-center text-xl-start">
                                            ...
                                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                                <a class="btn text-light btn-lg px-4 me-sm-3" style="border-style: none; background-color:#03C85D" href="{{ $itm->carousel_item_url }}">{{ $itm->carousel_item_button_name }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="py-3">
                <div class="container px-5 my-5">
                        ...
                        <div class="col-lg-6 mb-5 col-md-12 zoom">
                            <div class="card shadow border-0 p-3">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href='{{'/activitiesandprograms/' . $activities->year_id }}'><h1 class="card-title mb-3 montserrat">{{ $activities->year }}</h1></a>
                    ...
                    <div class="float-end">
                        <a class="text-decoration-none" href="activitiesandprograms">
            ...
            <section class="py-3">
                <div class="container px-5 my-5">
                        ...
                        <div class="col-lg-6 mb-5 col-md-12 zoom">
                            <div class="card shadow border-0 p-3">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <a class="text-decoration-none link-dark stretched-link" href='{{'/advocacy/' . $campaigns->campaign_id }}'><h1 class="card-title mb-3 montserrat">{{ $campaigns->campaign_name }}</h1></a>
                    ...
                    <div class="float-end">
                        <a class="text-decoration-none" href="advocacy">
                            ...
                            <div class="modal fade" id="moreSocial" tabindex="-1" aria-labelledby="moreSocialLabel" aria-hidden="true">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body p-2">
                                        ...
                                        <div class="card zoom mb-2" style="background-image: linear-gradient(to left, #03c85c42,white)">
                                            <div class="card-body">
                                                <a  class="text-decoration-none link-dark stretched-link fw-normal" href='{{ $socmed->social_link }}'><img class="me-2" src={{ asset('assets/galila_logo_small.png') }} alt="..." /> {{ ucfirst($socmed->social_name) }}</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-12 d-none d-xl-block">
                                    ...
                                    @if ($count == 3)
                                        <div class="card zoom mb-2" style="background-image: linear-gradient(to left, #03c85c42,white)">
                                            <div class="card-body">
                                                <a data-bs-toggle="modal" data-bs-target="#moreSocial" class="text-decoration-none link-dark stretched-link fw-normal"><i class="bi bi-three-dots"></i></a>
                                            </div>
                                        </div>
                                        @break 
                                    @endif
