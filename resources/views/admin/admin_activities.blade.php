            ...
            <div class="row gx-0">
                ...
                <div class="col-lg-11 col-xl-11 col-xxl-11">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-dark mb-2 montserrat">Activities and Programs</h1>
                    </div>
                </div>
            </div>
        </div>

        <form action="{{ route('updateActivitydesc') }}" method="post">
            @csrf
            ...
            <div class="container px-5 my-5">
                ...
                <div class="row gx-5">
                    ...
                    <div class="col-lg-6 mb-5 col-md-12 zoom">
                        ...
                        <a onclick="return confirm('Content under this Activities and Programs will be deleted. Are you sure to delete this?')" href={{'/deleteYear/' . $activities->year_id }} class="btn btn-secondary btn-sm float-end mt-3"><i class="bi bi-file-x-fill"></i></a>
                    </div>
                    ...
                    <div class="modal fade" id="createYear" tabindex="-1" aria-labelledby="createAdvocacyLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable p-5">
                          <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div>
                                    <div class="text-start float0">
                                        <div class="fs-6 fw-bolder text-dark montserrat mt-1">New Activities and Programs</div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body p-2">
                                ...
                                <form action={{'/addYear'}} method="post" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <span style="font-size: 10px" class="text-danger">
                                                    @error('whatyear'){{ $message }}

                                                    <script>
                                                        $(function() {
                                                            $('#createYear').modal('show');
                                                        });
                                                    </script>
                                                ...
                                                <input type="number" name="whatyear" placeholder="Year" class="form-control">
                                            </div>
  
                                            <div class="col-12 mt-2">

                                                <span style="font-size: 10px" class="text-danger">
                                                    @error('yeardesc'){{ $message }}
                                                ...
                                                <textarea type="text" name="yeardesc" placeholder="Description" class="form-control"></textarea>
                                              </div>
                ...
                <button data-bs-toggle="modal" data-bs-target="#createYear" style="background-color:#03C85D; color: white" class="btn"><i class="bi bi-plus-square"></i> New Activities and Programs</button>
            </div>
        </section>
