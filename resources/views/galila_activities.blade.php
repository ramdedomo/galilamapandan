    ...
    <body class="d-flex flex-column h-100 bg-dark bg-opacity-5">
     ...
     <header class="pt-5">
        ...
        <div class="container px-5 pb-5">
            <p>
                {{ $desc2[0]->activitiesprograms_desc }}
            </p>
        </div>
                    ...
                    <div class="col-lg-6 mb-5 col-md-12 zoom">
                        <div class="card shadow border-0 p-3">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href={{ "activitiesandprograms/" . $activities->year_id }}><h1 class="card-title mb-3">{{ $activities->year }}</h1></a>
